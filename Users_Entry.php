...
$sql_ins=mysqli_query($conn,"INSERT INTO users_tbl 
						VALUES(
							NULL,
							'$username',
							'$pwd' ,
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($conn,"UPDATE users_tbl SET 
								username='$username' ,
								password='$pwd' , 
								type='$note' ,
								note='$note'
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($conn,"SELECT * FROM users_tbl WHERE u_id=$id");
